...
array_to_subslice_to_mut_6e(Eurydice_array_u8x8 *a, core_ops_range_RangeTo_08 r)
{
...
*/
static Eurydice_mut_borrow_slice_u8
array_to_subslice_from_mut_8c(Eurydice_array_u8x8 *a, core_ops_range_RangeFrom_08 r)
{
  return
    (
      KRML_CLITERAL(Eurydice_mut_borrow_slice_u8){
        .ptr = a->data + r.start,
        .meta = (size_t)8U - r.start
      }
    );
}
